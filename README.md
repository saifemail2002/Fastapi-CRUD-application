...
### For the frontend of this project 
make sure to change to frontend directory , make sure node & other dpenedices are there (npm install)
and then run the frontend(npm start) will open  http://localhost:3000
